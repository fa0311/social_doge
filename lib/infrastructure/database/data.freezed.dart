...
mixin _$UserTableData {
  ...
  @JsonKey(ignore: true)
  $UserTableDataCopyWith<UserTableData> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UserTableDataCopyWith<$Res> {
  factory $UserTableDataCopyWith(
          UserTableData value, $Res Function(UserTableData) then) =
      _$UserTableDataCopyWithImpl<$Res, UserTableData>;
  @useResult
  $Res call(
      {String twitterId,
      String screenName,
...
/// @nodoc
class _$UserTableDataCopyWithImpl<$Res, $Val extends UserTableData>
    implements $UserTableDataCopyWith<$Res> {
  _$UserTableDataCopyWithImpl(this._value, this._then);
...
abstract class _UserTableDataFreezed implements UserTableData {
  const factory _UserTableDataFreezed(
